    ...
    <div className={classes.container}>
      ...
      <div className={classes.wrapper}>
        <div className={classes.left}>
          <img src={`https://real-estate-fix.vercel.app/images/${propertyDetail?.img}`} />
        </div>
            ...
            <div className={classes.priceAndOwner}>
              ...
              <span style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                Owner: {propertyDetail?.currentOwner?.profileImg
                  ? (
                    <img src={`https://real-estate-fix.vercel.app/images/${propertyDetail?.currentOwner?.profileImg}`} className={classes.owner} />
                  ) : (
      ...
      <div className={classes.commentSection}>
        ...
        {user?._id != null && <div className={classes.commentInput}>
          <img src={`https://real-estate-fix.vercel.app/images/${user?.profileImg}`} />
